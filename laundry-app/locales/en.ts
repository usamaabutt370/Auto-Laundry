...
export const en = {
  ...
  customer: {
    ...
    trackOrder: {
      ...
      statusProcessingBadge: "In progress",
      statusReadyBadge: "Ready",
      statusCompletedBadge: "Completed",
      statusCancelledBadge: "Cancelled",
      stepSent: "Request Sent",
      stepSentHint: "Your service request has been sent to the provider. You'll be notified once they confirm.",
      stepConfirmed: "Confirmed by Provider",
      stepConfirmedHint: "Provider will confirm your request.",
      stepPickedUp: "Items Picked Up",
      stepPickedUpHint: "Provider will pick up your items from your location.",
      stepOnTheWay: "On the Way",
      stepOnTheWayHint: "Your items are on the way back to you.",
      stepReadyPickup: "Ready for pickup",
      stepReadyPickupHint: "Your order is ready at the provider.",
      stepCompleted: "Completed",
      stepCompletedHint: "Your order has been completed.",
      ...
      dropoffTitle: "Drop off at provider",
    ...
    orderSummary: {
      ...
      continueToPayment: "Confirm Order",
