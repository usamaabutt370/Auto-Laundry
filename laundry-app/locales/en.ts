...
export const en = {
  ...
  customer: {
    home: {
      ...
      categoryLaundrySub: "Wash, dry & fold",
    ...
    bookService: {
      ...
      helpLaundry:
        "Pick the laundry service that matches your clothes. Wash & Fold is everyday laundry. Dry Cleaning is for suits, coats, and delicate pieces. Quantity is per priced item, not per kilogram.",
      helpIroning:
      ...
      quantity: "Quantity",
      quantityHint: "Tap a card to add or remove it. Use + / − on the card for quantity.",
      fromPrice: "From {price}",
      perPiece: "/ piece",
