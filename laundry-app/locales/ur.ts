...
export const ur = {
  ...
  customer: {
    home: {
      ...
      categoryLaundry: "لانڈری",
      categoryLaundrySub: "واش، ڈرائی اور فولڈ",
    ...
    bookService: {
      ...
      helpLaundry:
        "اپنے کپڑوں کے مطابق لانڈری سروس چنیں۔ واش اینڈ فولڈ روزمرہ کپڑوں کے لیے ہے۔ ڈرائی کلیننگ سوٹ، کوٹ اور نازک کپڑوں کے لیے ہے۔ مقدار فی آئٹم ہے، فی کلو نہیں۔",
      helpIroning:
      ...
      quantity: "مقدار",
      quantityHint: "کارڈ دبا کر شامل یا ہٹائیں۔ مقدار کے لیے کارڈ پر + / − استعمال کریں۔",
      fromPrice: "{price} سے",
      perPiece: "/ پیس",
